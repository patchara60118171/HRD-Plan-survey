...
async function runFormTest() {
    ...
    for (let i = 0; i < testData.length; i++) {
        ...
        try {
            ...
            // Step 2: Fill basic health data (skip problematic fields)
            try {
            ...
            try {
                ...
                // Digital systems (check multiple if available)
            ...
            await page.waitForSelector('#overlay-success:not(.hidden)', { timeout: 15000 });
