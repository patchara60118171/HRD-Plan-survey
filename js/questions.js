        ...
        subsections: [
            {
                ...
                questions: [
                    { id: 'lonely_1', text: 'ท่านรู้สึกว่าไม่มีใครเข้าใจท่านบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_2', text: 'ท่านรู้สึกว่าตนเองไม่มีใครคอยเป็นเพื่อนบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_3', text: 'ท่านรู้สึกว่าตนเองถูกทอดทิ้งบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_4', text: 'ท่านรู้สึกโดดเดี่ยวแม้จะอยู่ท่ามกลางผู้คนบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_5', text: 'ท่านรู้สึกว่าไม่มีใครที่พร้อมจะพูดคุยกับท่านบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true }
                ]
            },
            {
                ...
                hint: '3 = ฉันรู้สึกเช่นนี้บ่อยครั้ง, 2 = ฉันรู้สึกเช่นนี้เป็นบางครั้ง, 1 = ฉันแทบไม่เคยรู้สึกเช่นนี้, 0 = ฉันไม่เคยรู้สึกเช่นนี้เลย',
                questions: [
                    { id: 'lonely_6', text: 'ท่านรู้สึกว่ามีคนที่สามารถพึ่งพาได้เมื่อต้องการบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_7', text: 'ท่านรู้สึกว่ามีคนที่เข้าใจท่านอย่างแท้จริงบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_8', text: 'ท่านรู้สึกว่าสามารถแบ่งปันความรู้สึกกับคนรอบข้างได้บ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_9', text: 'ท่านรู้สึกว่ามีคนที่คอยรับฟังท่านบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_10', text: 'ท่านรู้สึกว่ามีความสัมพันธ์ที่ใกล้ชิดกับผู้อื่นบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true }
                ]
            },
            {
                ...
                hint: '3 = ฉันรู้สึกเช่นนี้บ่อยครั้ง, 2 = ฉันรู้สึกเช่นนี้เป็นบางครั้ง, 1 = ฉันแทบไม่เคยรู้สึกเช่นนี้, 0 = ฉันไม่เคยรู้สึกเช่นนี้เลย',
                questions: [
                    { id: 'lonely_11', text: 'ท่านรู้สึกว่าตนเองเป็นส่วนหนึ่งของกลุ่มเพื่อนบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_12', text: 'ท่านรู้สึกว่าตนเองมีความสำคัญต่อคนรอบข้างบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_13', text: 'ท่านรู้สึกว่าชีวิตของท่านมีความหมายบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_14', text: 'ท่านรู้สึกพอใจกับความสัมพันธ์ที่มีอยู่บ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_15', text: 'ท่านรู้สึกว่าตนเองมีคุณค่าในสายตาของผู้อื่นบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true }
                ]
            },
            {
                ...
                hint: '3 = ฉันรู้สึกเช่นนี้บ่อยครั้ง, 2 = ฉันรู้สึกเช่นนี้เป็นบางครั้ง, 1 = ฉันแทบไม่เคยรู้สึกเช่นนี้, 0 = ฉันไม่เคยรู้สึกเช่นนี้เลย',
                questions: [
                    { id: 'lonely_16', text: 'ท่านหลีกเลี่ยงการพบปะสังสรรค์กับผู้อื่นบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_17', text: 'ท่านเลือกที่จะอยู่คนเดียวมากกว่าอยู่กับคนอื่นบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_18', text: 'ท่านรู้สึกไม่สบายใจเมื่อต้องพูดคุยกับคนแปลกหน้าบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_19', text: 'ท่านรู้สึกยากลำบากในการเริ่มต้นบทสนทนากับผู้อื่นบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true },
                    { id: 'lonely_20', text: 'ท่านรู้สึกกังวลว่าคนอื่นจะปฏิเสธท่านบ่อยแค่ไหน?', type: 'scale', labels: ['0 - ไม่เคย', '1 - แทบไม่เคย', '2 - บางครั้ง', '3 - บ่อยครั้ง'], required: true }
                ]
            }
        ]
    }
