        ...
        subsections: [
            {
                ...
                questions: [
                    ...
                    { id: 'act_work_dur', text: '(จากข้อ 1) โดยเฉลี่ยต่อวัน คิดเป็นกี่ชั่วโมงหรือกี่นาที', type: 'time', required: true }
                ]
            },
            {
                ...
                questions: [
                    ...
                    { id: 'act_commute_dur', text: '(จากข้อ 3) โดยเฉลี่ยต่อวัน ท่านเดินทางสัญจรด้วยเท้าหรือปั่นจักรยานกี่ชั่วโมงหรือกี่นาที', type: 'time', required: true }
                ]
            },
            {
        ...
        subsections: [
            ...
            },
            {
                ...
                questions: [
                    ...
                    { id: 'lonely_8', text: 'ฉันไม่สนิทกับใคร', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
            ...
            },
            {
                ...
                questions: [
                    ...
                    { id: 'lonely_15', text: 'ไม่มีใครรู้จักฉันดีพอ', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true }
                ]
            },
            {
        ...
        subsections: [
            {
                ...
                questions: [
                    ...
                    { id: 'env_glare', text: 'ท่านทำงานกลางแดดอย่างต่อเนื่อง ทำงานในที่มีแสงจ้า', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่ มีผลต่อสุขภาพ', 'ไม่ใช่ ไม่มีผลต่อสุขภาพ'], required: true },
                    { id: 'env_noise', text: 'การทำงานของท่านมีเครื่องจักร หรือลักษณะการทำงานที่ก่อให้เกิดเสียงดัง หรือมีแรงสั่นสะเทือนหรือไม่', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่ มีผลต่อสุขภาพ', 'ไม่ใช่ ไม่มีผลต่อสุขภาพ'], required: true },
                    { id: 'env_smell', text: 'การทำงานของท่านมีกลิ่นเหม็นของสารเคมี', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่ มีผลต่อสุขภาพ', 'ไม่ใช่ ไม่มีผลต่อสุขภาพ'], required: true },
                    { id: 'env_smoke', text: 'การทำงานของท่านมีควัน ไอระเหย', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่ มีผลต่อสุขภาพ', 'ไม่ใช่ ไม่มีผลต่อสุขภาพ'], required: true },
                    { id: 'env_posture', text: 'การทำงานของท่าน ต้องนั่ง/ยืนในท่าทางเดิม ๆ หรือก้ม ๆ เงย ๆ เป็นเวลานานกว่าชั่วโมงครึ่งโดยไม่ได้พัก', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่ มีผลต่อสุขภาพ', 'ไม่ใช่ ไม่มีผลต่อสุขภาพ'], required: true },
                    { id: 'env_awkward', text: 'การทำงานของท่าน ต้องอยู่ในท่าทางที่ฝืนธรรมชาติ เช่น การยกแขนเหนือศีรษะ การยืนเขย่ง หรือไม่', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่ มีผลต่อสุขภาพ', 'ไม่ใช่ ไม่มีผลต่อสุขภาพ'], required: true }
                ]
            },
            {
