        ...
        subsections: [
            {
                ...
                questions: [
                    ...
                    { id: 'env_glare', text: 'ท่านทำงานกลางแดดอย่างต่อเนื่อง ทำงานในที่มีแสงจ้า', type: 'checkbox', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_noise', text: 'การทำงานของท่านมีเครื่องจักร หรือลักษณะการทำงานที่ก่อให้เกิดเสียงดัง หรือมีแรงสั่นสะเทือนหรือไม่', type: 'checkbox', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_smell', text: 'การทำงานของท่านมีกลิ่นเหม็นของสารเคมี', type: 'checkbox', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_smoke', text: 'การทำงานของท่านมีควัน ไอระเหย', type: 'checkbox', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_posture', text: 'ทำงานท่านต้องนั่ง/ยืนในท่าทางเดิม ๆ หรือก้ม ๆ เงย ๆ เป็นเวลานานกว่าชั่วโมงครึ่งโดยไม่ได้พัก', type: 'checkbox', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_awkward', text: 'การทำงานท่านต้องอยู่ในท่าทางที่ฝืนธรรมชาติ เช่น การยกแขนเหนือศีรษะ การยืนเขย่ง หรือไม่', type: 'checkbox', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true }
                ]
            },
            {
