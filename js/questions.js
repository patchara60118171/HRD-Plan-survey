...
const SURVEY_DATA = {
    ...
    mental: {
        ...
        subsections: [
            {
                title: '**คำถามในหมวดนี้เกี่ยวข้องกับมุมมองและความรู้สึกต่อการใช้ชีวิตโดยทั่วไป ในช่วง 1 เดือนที่ผ่านมา (ตัวหนา)\n*ข้อมูลส่วนนี้ จะช่วยให้หน่วยงานออกแบบแนวทางสนับสนุนที่เหมาะสมกับบริบทชีวิตของบุคลากรได้ดียิ่งขึ้น (ตัวบาง)*',
        ...
        subsections: [
            {
                ...
                questions: [
                    { id: 'helmet_driver', text: 'ในช่วง 30 วันที่ผ่านมา ท่านสวมหมวกนิรภัยขณะ "ขับขี่" รถจักรยานยนต์หรือไม่', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยขี่'], required: true },
                    { id: 'helmet_passenger', text: 'ในช่วง 30 วันที่ผ่านมา ท่านสวมหมวกนิรภัยขณะ "โดยสาร" รถจักรยานยนต์หรือไม่', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยนั่งซ้อนท้าย'], required: true },
                    { id: 'seatbelt_driver', text: 'ในช่วง 30 วันที่ผ่านมา ท่านใช้เข็มขัดนิรภัยขณะ "ขับรถยนต์" หรือไม่', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยขับ'], required: true },
                    { id: 'seatbelt_passenger', text: 'ในช่วง 30 วันที่ผ่านมา ท่านใช้เข็มขัดนิรภัยขณะเป็น "ผู้โดยสารข้างคนขับ" หรือไม่', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยนั่งข้างคนขับ'], required: true },
                    {
                        id: 'accident_hist',
