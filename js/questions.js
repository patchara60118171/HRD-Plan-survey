        ...
        subsections: [
            {
                title: 'การทำงาน',
                questions: [
                    { id: 'act_work_days', text: 'ท่านปฏิบัติกิจกรรมทางกายในหมวดของการทำงาน ใน 1 สัปดาห์ ……………. วัน *', type: 'number', required: true, tooltip: 'การเคลื่อนไหวที่เกิดขึ้น เป็นส่วนหนึ่งของงาน ตามเวลาทำงานปกติของท่าน เช่น เดินตรวจงาน เดินส่งเอกสาร ขึ้น-ลงบันได งานบริการที่ต้องเคลื่อนไหว ยก/ขนของ รวมถึงการเดินหรือปั่นจักรยานที่ใช้เพื่อปฏิบัติงาน หากเกิดระหว่างการทำงาน ให้นับในข้อนี้' },
            ...
            },
            {
                title: 'การเดินทาง',
                questions: [
                    { id: 'act_commute_days', text: 'ท่านปฏิบัติกิจกรรมทางกายในหมวดของการเดินทางสัญจรด้วยเท้า/ปั่นจักรยาน ใน 1 สัปดาห์ ……………. วัน *', type: 'number', required: true, tooltip: 'การเดินทาง นอกเวลาทำงาน เช่น เดินหรือปั่นจักรยานไป-กลับที่พัก ไปซื้อของ หรือการเดินทางส่วนตัว ไม่นับกิจกรรมที่เกิดระหว่างการทำงาน' },
