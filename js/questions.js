...
const SURVEY_DATA = {
        ...
        subsections: [
            {
                ...
                questions: [
                    ...
                    { id: 'age', text: 'อายุ', type: 'number', unit: 'ปี', required: true },
                    {
                        id: 'org_type',
                        text: 'ประเภทหน่วยงาน',
                        type: 'radio',
                    ...
                    { id: 'job_duration', text: 'อายุราชการในหน่วยงานปัจจุบัน', type: 'number', unit: 'ปี', required: true },
                    {
                        id: 'activity_org',
            ...
            },
            {
                ...
                questions: [
                    { id: 'height', text: 'ส่วนสูง', type: 'number', unit: 'เซนติเมตร', required: true },
                    { id: 'weight', text: 'น้ำหนัก', type: 'number', unit: 'กิโลกรัม', required: true },
                    { id: 'waist', text: 'เส้นรอบเอว', type: 'number', unit: 'นิ้ว', required: true }
                ]
            }
        ]
    },
    ...
    nutrition: {
        ...
        subsections: [
            ...
            },
            {
                title: 'โซเดียม (เค็ม)',
                questions: [
                    { id: 'salt_1', text: 'ชิมอาหารก่อนปรุงน้ำปลา / ซีอิ๊ว / ซอส ในปริมาณน้อย หรือไม่ปรุงเพิ่ม', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
    ...
    activity: {
        ...
        subsections: [
            {
                title: 'การทำงาน<br><span style="color: #6B7280; font-size: 0.875rem; font-weight: normal;">กดที่ i เพื่ออ่านคำอธิบายเพิ่ม</span>',
                questions: [
                    { id: 'act_work_days', text: 'ท่านปฏิบัติกิจกรรมทางกายในหมวดของการทำงาน', type: 'number', unit: 'วันต่อสัปดาห์', required: true, tooltip: 'หมายถึง การเคลื่อนไหวที่เกิดขึ้นซึ่งเป็นส่วนหนึ่งของงาน "ตามเวลาทำงานปกติ" ของท่าน เช่น เดินตรวจงาน เดินส่งเอกสาร ขึ้น-ลงบันได งานบริการที่ต้องเคลื่อนไหว ยก/ขนของ รวมถึงการเดินหรือปั่นจักรยานที่ใช้เพื่อปฏิบัติงาน หากกิจกรรมเหล่านี้เกิดระหว่างการทำงาน ให้นับในข้อนี้' },
                    { id: 'act_work_dur', text: 'จากกิจกรรมในข้อ 1 โดยเฉลี่ยต่อวัน ท่านใช้เวลากี่ชั่วโมง/นาที', type: 'time', required: true }
                ]
            },
            {
                title: 'การเดินทาง (นอกเวลาทำงาน)<br><span style="color: #6B7280; font-size: 0.875rem; font-weight: normal;">กดที่ i เพื่ออ่านคำอธิบายเพิ่ม</span>',
                questions: [
                    { id: 'act_commute_days', text: 'ท่านปฏิบัติกิจกรรมทางกายในหมวดของการเดินทางสัญจรด้วยเท้า/ปั่นจักรยาน', type: 'number', unit: 'วันต่อสัปดาห์', required: true, tooltip: 'หมายถึง การเดินทาง "นอกเวลาทำงาน" เช่น เดินหรือปั่นจักรยานไป-กลับที่พัก ไปซื้อของ หรือการเดินทางส่วนตัวไม่นับกิจกรรมที่เกิดระหว่างการทำงาน' },
                    { id: 'act_commute_dur', text: 'จากกิจกรรมในข้อ 3 โดยเฉลี่ยต่อวัน ท่านใช้เวลากี่ชั่วโมง/นาที', type: 'time', required: true }
                ]
            },
            {
                title: 'นันทนาการ/ออกกำลังกาย',
                questions: [
                    { id: 'act_rec_days', text: 'ท่านปฏิบัติกิจกรรมทางกายในหมวดของกิจกรรมนัทนาการ/ออกกำลังกาย', type: 'number', unit: 'วันต่อสัปดาห์', required: true },
                    { id: 'act_rec_dur', text: '(จากข้อ 5) โดยเฉลี่ยต่อวัน ท่านปฏิบัติกิจกรรมทางกายในหมวดของกิจกรรมนัทนาการ/ออกกำลังกาย', type: 'time', required: true }
                ]
            },
            {
                title: 'พฤติกรรมเนือยนิ่ง/หน้าจอ',
                questions: [
                    { id: 'sedentary_dur', text: 'โดยเฉลี่ยต่อวัน ท่านนั่งหรือเอนกายหรือเคลื่อนไหวน้อย ๆ ซึ่งไม่รวมถึงการนอนหลับพักผ่อน', type: 'time', required: true },
                    { id: 'screen_entertain', text: 'โดยเฉลี่ยต่อวัน ท่านใช้เวลาดูทีวี ใช้โทรศัพท์มือถือ เล่นคอมพิวเตอร์เพื่อความบันเทิง', type: 'time', required: true },
                    { id: 'screen_work', text: 'โดยเฉลี่ยต่อวัน ท่านใช้คอมพิวเตอร์ หรืออุปกรณ์อิเล็กทรอนิกส์หน้าจอต่างๆ เพื่อทำงาน หรือการเรียนรู้', type: 'time', required: true }
                ]
            }
        ]
    },
    ...
    mental: {
        ...
        subsections: [
            {
                title: '<strong>คำถามในหมวดนี้เกี่ยวข้องกับมุมมองและความรู้สึกต่อการใช้ชีวิตโดยทั่วไป ในช่วง 1 เดือนที่ผ่านมา</strong><br><span style="color: #6B7280; font-weight: normal;">ข้อมูลส่วนนี้ จะช่วยให้หน่วยงานออกแบบแนวทางสนับสนุนที่เหมาะสมกับบริบทชีวิตของบุคลากรได้ดียิ่งขึ้น</span>',
        ...
        subsections: [
            {
                ...
                questions: [
                    { id: 'lonely_1', text: 'ฉันไม่มีความสุขที่ต้องทำสิ่งต่าง ๆ คนเดียว', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_2', text: 'ฉันไม่มีใครให้คุยด้วย', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_3', text: 'ฉันทนไม่ได้ที่จะอยู่คนเดียวอย่างนี้', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_4', text: 'ฉันขาดมิตรภาพ', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_5', text: 'ฉันรู้สึกราวกับว่าไม่มีใครเข้าใจฉันจริงๆ', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true }
                ]
            },
            {
                ...
                hint: '3 = ฉันรู้สึกเช่นนี้บ่อยครั้ง, 2 = ฉันรู้สึกเช่นนี้เป็นบางครั้ง, 1 = ฉันแทบไม่เคยรู้สึกเช่นนี้, 0 = ฉันไม่เคยรู้สึกเช่นนี้เลย',
                questions: [
                    { id: 'lonely_6', text: 'ฉันพบว่าตัวเองมักรอให้คนอื่นติดต่อมาก่อน', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_7', text: 'ฉันไม่มีใครให้พึ่ง', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_8', text: 'ฉันรู้สึกว่าไม่เหลือคนที่สนิทด้วยแล้ว', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_9', text: 'ความสนใจและความคิดของฉันไม่ค่อยสอดคล้องกับคนรอบข้าง', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_10', text: 'ฉันรู้สึกถูกทอดทิ้ง', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true }
                ]
            },
            {
                ...
                hint: '3 = ฉันรู้สึกเช่นนี้บ่อยครั้ง, 2 = ฉันรู้สึกเช่นนี้เป็นบางครั้ง, 1 = ฉันแทบไม่เคยรู้สึกเช่นนี้, 0 = ฉันไม่เคยรู้สึกเช่นนี้เลย',
                questions: [
                    { id: 'lonely_11', text: 'ฉันรู้สึกโดดเดี่ยวโดยสิ้นเชิง', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_12', text: 'ฉันไม่สามารถติดต่อสื่อสารกับคนรอบข้างได้', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_13', text: 'ฉันมีความสัมพันธ์ทางสังคมเพียงผิวเผิน', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_14', text: 'ฉันโหยหาการมีเพื่อนพ้อง', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_15', text: 'ไม่มีใครเข้าใจฉันอย่างแท้จริง', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true }
                ]
            },
            {
                ...
                hint: '3 = ฉันรู้สึกเช่นนี้บ่อยครั้ง, 2 = ฉันรู้สึกเช่นนี้เป็นบางครั้ง, 1 = ฉันแทบไม่เคยรู้สึกเช่นนี้, 0 = ฉันไม่เคยรู้สึกเช่นนี้เลย',
                questions: [
                    { id: 'lonely_16', text: 'ฉันรู้สึกถูกแยกออกจากคนอื่นๆ', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_17', text: 'ฉันไม่มีความสุขที่ตัวเองถอยห่างจากสังคม', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_18', text: 'การทำความรู้จักกับคนใหม่ ๆ เป็นเรื่องยากสำหรับฉัน', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_19', text: 'ฉันรู้สึกถูกกีดกัน และถูกตัดขาดออกจากผู้อื่น', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true },
                    { id: 'lonely_20', text: 'แม้มีคนมากมายอยู่รอบตัวแต่ฉันก็ยังรู้สึกโดดเดี่ยว', type: 'scale', labels: ['ไม่เคย', 'แทบไม่เคย', 'บางครั้ง', 'บ่อยครั้ง'], required: true }
                ]
            }
        ]
    },
    ...
    safety: {
        ...
        type: 'environment',
        description: 'ความปลอดภัยในการเดินทางและการทำงาน',
        subsections: [
            {
                title: 'การขับขี่และการเดินทาง',
                questions: [
                    { id: 'helmet_driver', text: 'ในช่วง 30 วันที่ผ่านมา ท่านสวมหมวกนิรภัยขณะ <strong>"ขับขี่"</strong> รถจักรยานยนต์หรือไม่', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยขี่'], required: true },
                    { id: 'helmet_passenger', text: 'ในช่วง 30 วันที่ผ่านมา ท่านสวมหมวกนิรภัยขณะ <strong>"โดยสาร"</strong> รถจักรยานยนต์หรือไม่', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยนั่งซ้อนท้าย'], required: true },
                    { id: 'seatbelt_driver', text: 'ในช่วง 30 วันที่ผ่านมา ท่านใช้เข็มขัดนิรภัยขณะ <strong>"ขับรถยนต์"</strong> หรือไม่', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยขับ'], required: true },
                    { id: 'seatbelt_passenger', text: 'ในช่วง 30 วันที่ผ่านมา ท่านใช้เข็มขัดนิรภัยขณะเป็น <strong>"ผู้โดยสารข้างคนขับ"</strong> หรือไม่', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยนั่งข้างคนขับ'], required: true },
                    {
                        id: 'accident_hist',
        ...
        subsections: [
            {
                ...
                questions: [
                    { id: 'env_satisfaction', text: 'ท่านจัดอันดับความพึงพอใจในสิ่งแวดล้อมในการทำงาน อยู่ในระดับใด', type: 'scale', labels: ['แย่มาก', 'แย่', 'ปานกลาง', 'ดี', 'ดีมาก'], required: true },
                    { id: 'env_glare', text: 'ท่านทำงานกลางแดดอย่างต่อเนื่อง ทำงานในที่มีแสงจ้า', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่'], required: true },
                    { id: 'env_noise', text: 'การทำงานของท่านมีเครื่องจักร หรือลักษณะการทำงานที่ก่อให้เกิดเสียงดัง หรือมีแรงสั่นสะเทือนหรือไม่', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่'], required: true },
                    { id: 'env_smell', text: 'การทำงานของท่านมีกลิ่นเหม็นของสารเคมี', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่'], required: true },
                    { id: 'env_smoke', text: 'การทำงานของท่านมีควัน ไอระเหย', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่'], required: true },
                    { id: 'env_posture', text: 'การทำงานของท่าน ต้องนั่ง/ยืนในท่าทางเดิม ๆ หรือก้ม ๆ เงย ๆ เป็นเวลานานกว่าชั่วโมงครึ่งโดยไม่ได้พัก', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่'], required: true },
                    { id: 'env_awkward', text: 'การทำงานของท่าน ต้องอยู่ในท่าทางที่ฝืนธรรมชาติ เช่น การยกแขนเหนือศีรษะ การยืนเขย่ง หรือไม่', type: 'radio', options: ['ใช่ มีผลต่อสุขภาพ', 'ใช่ ไม่มีผลต่อสุขภาพ', 'ไม่ใช่'], required: true }
                ]
            },
            {
                title: 'มลพิษและโรคอุบัติใหม่',
                questions: [
                    { id: 'pm25_impact', text: 'ในพื้นที่ที่ท่านอยู่อาศัยในช่วง 12 เดือนที่ผ่านมา มีปัญหามลพิษทางอากาศ ได้แก่ ฝุ่นพีเอ็ม 2.5 ในระดับใด', type: 'radio', options: ['ไม่มีเลย', 'น้อย', 'ปานกลาง', 'มาก', 'รุนแรงมาก'], required: true },
                    ...
                    { id: 'life_quality', text: 'ท่านจัดอันดับคุณภาพชีวิตของท่านโดยรวมว่าอยู่ในระดับใด', type: 'scale', labels: ['แย่มาก', 'แย่', 'ปานกลาง', 'ดี', 'ดีมาก'], required: true },
                    { id: 'emerging_known', text: 'ท่านเคยได้ยินคำว่า "โรคอุบัติใหม่" หรือไม่', type: 'radio', options: ['เคย', 'ไม่เคย'], required: true },
                    { id: 'emerging_list', text: 'โรคอุบัติใหม่ที่ท่านรู้จัก (เลือกได้หลายข้อ)', type: 'checkbox', options: ['COVID-19', 'ไข้หวัดนก', 'ไข้ซิกา', { label: 'อื่น ๆ (ระบุ)', value: 'other', hasInput: true }], required: true },
