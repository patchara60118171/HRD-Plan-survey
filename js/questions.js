        ...
        subsections: [
            {
                ...
                questions: [
                    { id: 'sweet_1', text: 'ดื่มน้ำอัดลม', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
                    { id: 'sweet_2', text: 'ดื่มเครื่องดื่มชง (กาแฟเย็น/ปั่น/ชานม/น้ำหวาน)', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
            ...
            },
            {
                title: 'ไขมัน',
                questions: [
                    { id: 'fat_1', text: 'เลือกกินเนื้อสัตว์ติดมัน ติดหนัง', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
                    { id: 'fat_2', text: 'กินอาหารทอด ฟาสฟู้ด ผัดน้ำมันเยิ้ม', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
                    { id: 'fat_3', text: 'กินอาหารที่มีกะทิ แกงกะทิ', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
                    { id: 'fat_4', text: 'ดื่มเครื่องดื่มใส่ครีมเทียม/วิปปิ้งครีม/นมข้นหวาน', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
                    { id: 'fat_5', text: 'ซดน้ำผัด น้ำแกง หรือราดน้ำแกงชุ่มๆ', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true }
                ]
            },
            {
                title: 'โซเดียม (เค็ม)',
                questions: [
                    ...
                    { id: 'salt_4', text: 'กินบะหมี่/โจ๊กกึ่งสำเร็จรูป อาหารแช่แข็ง', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
                    { id: 'salt_5', text: 'กินผลไม้ดอง แช่อิ่ม จิ้มพริกเกลือ/น้ำปลาหวาน', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true }
                ]
            }
        ]
    },
        ...
        subsections: [
            {
                ...
                questions: [
                    { id: 'helmet_driver', text: 'สวมหมวกนิรภัยขณะขับขี่รถจักรยานยนต์', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยขี่'], required: true },
                    { id: 'helmet_passenger', text: 'สวมหมวกนิรภัยขณะโดยสารรถจักรยานยนต์', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยซ้อน'], required: true },
                    { id: 'seatbelt_driver', text: 'คาดเข็มขัดนิรภัยขณะขับรถยนต์', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยขับ'], required: true },
                    { id: 'seatbelt_passenger', text: 'คาดเข็มขัดนิรภัยขณะโดยสารรถยนต์', type: 'radio', options: ['ใช้ทุกครั้ง', 'ใช้บางครั้ง', 'ไม่เคยใช้', 'ไม่เคยนั่ง'], required: true },
                    {
                        id: 'accident_hist',
                        text: 'ใน 12 เดือนที่ผ่านมา ท่านเคยประสบอุบัติเหตุจราจรในลักษณะใดบ้าง (เลือกได้มากกว่า 1 ข้อ)',
                        type: 'checkbox',
                    ...
                    {
                        id: 'drunk_drive',
                        text: 'ใน 12 เดือนที่ผ่านมา เคยขับขี่หลังดื่มแอลกอฮอล์หรือไม่',
                        type: 'radio',
