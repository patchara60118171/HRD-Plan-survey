        ...
        subsections: [
                ...
                questions: [
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            'นักพัฒนาชุมชน',
                            'นักจัดการงานทั่วไป',
                            'นักสื่อสารการแพทย์และสาธารณสุข',
                            'นักเทคนิคการแพทย์',
                            'นักรังสีการแพทย์',
                            'นักกายภาพบำบัด',
                            'นักโภชนาการ',
                    ...
                    { id: 'job_duration', text: 'อายุราชการในหน่วยงานปัจจุบัน (ปี)', type: 'number', required: true },
                    {
                        id: 'activity_org',
            ...
            },
            {
                ...
                questions: [
                    ...
                    { id: 'waist', text: 'เส้นรอบเอว [--ช่องให้ใส่ค่า--] นิ้ว', type: 'number', required: true }
                ]
            }
        ]
    },
        ...
        subsections: [
            {
                ...
                questions: [
                    {
                        id: 'q2001',
                        text: 'ในระยะเวลา 2 เดือนที่ผ่านมา ท่านเคยสูบบุหรี่ (มวน) หรือไม่',
                        type: 'radio',
        ...
        subsections: [
            {
                ...
                questions: [
                    { id: 'sweet_1', text: 'ดื่มน้ำเปล่า / กาแฟดำ / ชาไม่ใส่น้ำตาล / โซดา (เครื่องดื่มมีส่วนประกอบของน้ำตาล)', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
        ...
        subsections: [
            {
                ...
                questions: [
                    ...
                    { id: 'env_glare', text: 'ท่านทำงานกลางแดดอย่างต่อเนื่อง ทำงานในที่มีแสงจ้า', type: 'radio', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_noise', text: 'การทำงานของท่านมีเครื่องจักร หรือลักษณะการทำงานที่ก่อให้เกิดเสียงดัง หรือมีแรงสั่นสะเทือนหรือไม่', type: 'radio', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_smell', text: 'การทำงานของท่านมีกลิ่นเหม็นของสารเคมี', type: 'radio', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_smoke', text: 'การทำงานของท่านมีควัน ไอระเหย', type: 'radio', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_posture', text: 'ทำงานท่านต้องนั่ง/ยืนในท่าทางเดิม ๆ หรือก้ม ๆ เงย ๆ เป็นเวลานานกว่าชั่วโมงครึ่งโดยไม่ได้พัก', type: 'radio', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true },
                    { id: 'env_awkward', text: 'การทำงานท่านต้องอยู่ในท่าทางที่ฝืนธรรมชาติ เช่น การยกแขนเหนือศีรษะ การยืนเขย่ง หรือไม่', type: 'radio', options: ['ใช่', 'ไม่ใช่', 'มีผลกระทบต่อสุขภาพ', 'ไม่มีผลกระทบต่อสุขภาพ'], required: true }
                ]
            },
            {
