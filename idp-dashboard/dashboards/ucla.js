...
const ITEM_LABELS = ["ไม่มีความสุขที่ต้องทำสิ่งต่างๆ คนเดียว", "ไม่มีใครให้คุยด้วย", "ทนไม่ได้ที่จะอยู่คนเดียวอย่างนี้", "ขาดมิตรภาพ", "รู้สึกราวกับไม่มีใครเข้าใจฉันจริงๆ", "มักรอให้คนอื่นติดต่อมาก่อน", "ไม่มีใครให้พึ่งพิง", "รู้สึกว่าไม่เหลือคนที่สนิทด้วยแล้ว", "ความสนใจไม่สอดคล้องกับคนรอบข้าง", "รู้สึกถูกทอดทิ้ง", "รู้สึกโดดเดี่ยวโดยสิ้นเชิง", "ไม่สามารถติดต่อสื่อสารกับคนรอบข้างได้", "มีความสัมพันธ์ทางสังคมเพียงผิวเผิน", "โหยหาการมีเพื่อนพ้อง", "ไม่มีใครเข้าใจฉันอย่างแท้จริง", "รู้สึกถูกแยกออกจากคนอื่นๆ", "ไม่มีความสุขที่ตัวเองถอยห่างจากสังคม", "การทำความรู้จักกับคนใหม่ๆ เป็นเรื่องยาก", "รู้สึกถูกกีดกันและถูกตัดขาดจากผู้อื่น", "แม้มีคนมากมายอยู่รอบตัวแต่ยังรู้สึกโดดเดี่ยว"];
const LEVEL_CFG = [{
  key: "low",
  label: "เหงาน้อย",
  range: "20–34",
...
function UCLADashboard() {
  ...
  const listData = [...employees].sort((a, b) => b.total - a.total).filter(e => filter === "all" || e.level.key === filter);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "NIDA \xB7 ", employees.length, " \u0E04\u0E19 \xB7 \u0E04\u0E30\u0E41\u0E19\u0E19\u0E40\u0E15\u0E47\u0E21 60 \xB7 \u0E22\u0E34\u0E48\u0E07\u0E2A\u0E39\u0E07 = \u0E22\u0E34\u0E48\u0E07\u0E40\u0E2B\u0E07\u0E32")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10
    }
    ...
    const highPct = highGroup.length > 0 ? Math.round(highGroup.reduce((s, e) => s + e.dimScores.find(x => x.key === d.key).pct, 0) / highGroup.length) : 0;
