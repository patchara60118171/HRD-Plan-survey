...
return (
<div style={{ fontFamily:"'IBM Plex Sans Thai Looped',sans-serif", background:"#F1F5F9", minHeight:"100vh" }}>
          ...
          <div style={{ background:"#fff", borderRadius:16, padding:24, boxShadow:"0 1px 3px rgba(0,0,0,0.07)" }}>
            ...
            <ResponsiveContainer width="100%" height={180}>
              <RadarChart data={radarData}>
                ...
                <PolarAngleAxis dataKey="dim" tick={{ fill:"#6B7280", fontSize:10, fontFamily:"'IBM Plex Sans Thai Looped',sans-serif" }} />
                ...
                <Legend wrapperStyle={{ fontFamily:"'IBM Plex Sans Thai Looped',sans-serif", fontSize:11 }} />
              </RadarChart>
            </ResponsiveContainer>
          </div>
        </div>
