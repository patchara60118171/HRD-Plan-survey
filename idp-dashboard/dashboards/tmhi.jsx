  ...
  return (
    <svg width={size} height={size * 0.72} viewBox={`0 0 ${size} ${size * 0.72}`}>
        ...
        return (
          <g key={v}>
            ...
            <text x={lbl.x} y={lbl.y} textAnchor="middle" dominantBaseline="middle"
              fontSize={size*0.055} fill="#94A3B8" fontFamily="'IBM Plex Sans Thai Looped','Sarabun',system-ui,sans-serif">{v}</text>
          </g>
        );
      })}
      ...
      <text x={cx} y={cy+size*0.1} textAnchor="middle" fontSize={size*0.13}
        fontWeight="800" fill={lvl.color} fontFamily="'IBM Plex Sans Thai Looped','Sarabun',system-ui,sans-serif">{score}</text>
      <text x={cx} y={cy+size*0.21} textAnchor="middle" fontSize={size*0.06}
        fill="#64748B" fontFamily="'IBM Plex Sans Thai Looped','Sarabun',system-ui,sans-serif">/ 60</text>
    </svg>
  );
};
...
function TMHIDashboard() {
  ...
  return (
    <div style={{ fontFamily:"'IBM Plex Sans Thai Looped','Sarabun',system-ui,sans-serif", background:"#FFF7ED", minHeight:"100vh" }}>
      {/* Header */}
      <div style={{
                ...
                <div>
                  ...
                  <ResponsiveContainer width="100%" height={280}>
                    <RadarChart data={orgRadar}>
                      ...
                      <PolarAngleAxis dataKey="dim" tick={{ fill:"#6B7280", fontSize:11, fontFamily:"'IBM Plex Sans Thai Looped','Sarabun',system-ui,sans-serif" }} />
