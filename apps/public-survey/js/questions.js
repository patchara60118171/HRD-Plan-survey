        ...
        subsections: [
            {
                ...
                questions: [
                    { id: 'sweet_1', text: 'ดื่มน้ำเปล่า / กาแฟดำ / ชาไม่ใส่น้ำตาล / โซดา (เครื่องดื่มที่ไม่มีส่วนประกอบของน้ำตาล)', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
                    { id: 'sweet_2', text: 'ดื่มน้ำอัดลม / กาแฟ 3 in 1 / กาแฟเย็น / กาแฟปั่น / เครื่องดื่มชง / น้ำหวาน / นมเปรี้ยว (เครื่องดื่มที่มีส่วนประกอบของน้ำตาล)', type: 'radio', options: ['ทุกวัน / เกือบทุกวัน', '3-4 ครั้งต่อสัปดาห์', 'แทบไม่ทำ / ไม่ทำเลย'], required: true },
